    ...
    init: function () {
      ...
      new Game.buffType('outlawsFortune', function () {
        return {
          ...
          desc: loc('Harness the spirit of the Wild West and watch your cookie production soar! Gain a 50% increase in cookie output for %1 minutes.',Game.sayTime((10 * 60) * Game.fps,-1)),
          icon: [20, 19, 'https://voltacceptyt.github.io/redbreadcrossover/img/icons.png'],
          time: (10 * 60) * Game.fps,
          multCpS: 1.5
        };
      });
      ...
      new Game.buffType('frontierSpirit', function () {
        return {
          ...
          desc: loc('Embrace the rugged determination of the frontier. All buildings produce cookies 25% faster for 15 minutes',Game.sayTime((10 * 60) * Game.fps,-1)),
          icon: [20, 19, 'https://voltacceptyt.github.io/redbreadcrossover/img/icons.png'],
          time: (15 * 60) * Game.fps,
          power: 1.25
        };
